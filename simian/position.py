...
def check_overlap_xy(bbox1, bbox2, padding=0.6):
    ...
    overlap = not (min1.x > max2.x + padding or max1.x < min2.x - padding or
...
def place_objects_on_grid(objects, largest_length):
    for obj_dict in objects:
        ...
        obj.location = Vector((transformed_position[0]*largest_length, transformed_position[1]*largest_length, 0))
