...
def get_background_path(background_path, combination) -> str:
...
def get_background(background_path, combination) -> None:
    """Get the background HDR image of the scene."""
...
def set_background(background_path, combination) -> None:
...
def create_photosphere(background_path, combination):
...
def create_photosphere_material(background_path, combination, sphere):
